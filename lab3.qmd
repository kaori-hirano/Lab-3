...
ggplot(sim_data, aes(x1, y1)) + 
  ...
  geom_function(aes(color = "GBM Model"), 
                ...
                linewidth = 1.25) +
  theme_minimal() +
  geom_function(fun = y1_fun, linewidth = 1, color = 'orchid4')
# adds true function
...
ggplot(sim_data, aes(x1, y2)) + 
  ...
  geom_function(aes(color = "GBM Model"), 
                ...
                linewidth = 1.25) + 
  theme_minimal() +
   geom_function(fun = y2_fun, linewidth = 1, color = "darkorchid4") # adds true function line
```
...
## Q6
Based on what I got there isn't much of a reason to use cross validation, but I'm assuming that the results were supposed to conflict? Cross validation would help by further splitting up the data and having more train cases.
Using cross validation will help us get a better picture of what fits the data better
by allowing us to use more cases to train with. 
...
my12 <- glm(y1 ~ x1, data = sim_data)
glm_cv <- cv.glm(sim_data, my12, K = 10)
glm_cv$delta
